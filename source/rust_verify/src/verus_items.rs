...
fn verus_items_map() -> Vec<(&'static str, VerusItem)> {
    vec![
        ("verus::verus_builtin::proof_with",                VerusItem::PassTracked),
        ("verus::verus_builtin::declare_with",               VerusItem::DeclareWith),
        ("verus::verus_builtin::declare_with_tracked",       VerusItem::DeclareWith),
        ("verus::verus_builtin::declare_with_ghost",         VerusItem::DeclareWith),
