        ...
        match prefix {
            ...
            AttrPrefix::Verus(verus_prefix) => match verus_prefix {
                VerusPrefix::Internal => match &attr {
                    ...
                    AttrTree::Fun(_, arg, None) if arg == "unverified_stub" => {
                        v.push(Attr::UnverifiedStub)
                    }
                    AttrTree::Fun(_, arg, None) if arg == "verified_with" => {
                        v.push(Attr::VerifiedWith)
                    }
                    AttrTree::Fun(_, arg, None) if arg == "verified_trait" => {
                        v.push(Attr::VerifiedTrait)
                    }
